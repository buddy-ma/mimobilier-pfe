<aside class="app-sidebar">
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ url('/promoteur/dashboard') }}">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ url('/promoteur/annonces') }}">
                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                    width="24">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
                ...
                <span class="side-menu__label">Annonces</span></a>
        </li>
        <li class="slide">
            <a class="side-menu__item" href="{{ url('/promoteur/paiement') }}">
                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                    width="24">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
