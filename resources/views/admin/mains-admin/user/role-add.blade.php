...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Create Role</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a><i class="fe fe-layout  mr-2 fs-14"></i>Tables</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="">Create Role</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body pb-2">
                    ...
                    @endif
                    <form action="{{ route('role-add') }}" method='POST' role="form" enctype="multipart/form-data">
                        @csrf
