                ...
                <tbody>
                    @foreach ($paiement as $item)
                        <tr>
                            ...
                            <td width="20%">
                                <a target="_blank" href="{{ asset('files/facture.pdf') }}" class="btn btn-primary">
                                    <i class="fa fa-file-text" title="facture"></i></a>
                                <a href="{{ url('admin/paiement/' . $item->id) }}" class="btn btn-info"> <i
                                        class="fa fa-pencil" title="edite paiement"></i></a>
