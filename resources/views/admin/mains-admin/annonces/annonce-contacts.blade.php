...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Demandes de visites</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page"><a href="">Demandes de visites</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
...
@section('content')
    ...
    <div class="row flex-lg-nowrap">
        <div class="col-12">
            ...
            @livewire('product-contacts-admin')
